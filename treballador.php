...
<body>
  ...
  if (isset($_GET['id']) && is_numeric($_GET['id']) && $resultado = mysqli_query($con, 'SELECT id_rol, nom, cognom, edat, antiguitat, data_naixement, usuari FROM treballadors WHERE id = ' . $_GET['id'])) {
